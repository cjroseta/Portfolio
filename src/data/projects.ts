...
export const projects: Project[] = [
  {
    ...
    title: 'Migração Odoo v17 → v18 & Odoo SH',
    description: 'Migração completa de um ERP crítico em produção para nova versão e infraestrutura cloud, sem interrupção da operação.',
    longDescription: 'Liderança técnica da migração de um ambiente Odoo em produção da v17 para a v18, com transição para a infraestrutura cloud Odoo SH e preparação para a migração futura à v19 — sem parar a operação diária da empresa.',
    category: 'case-study',
    stack: ['Odoo 18', 'Odoo SH', 'Python', 'XML', 'PostgreSQL', 'Git/GitHub'],
    image: '/projects/odoo-migration.png',
    highlights: [
    ...
    caseStudy: {
      ...
      objectives: [
        'Migrar o ERP para a versão 18 sem interromper a operação diária',
      ...
      diagramFlow: ['Odoo v17 (Produção)', 'Staging em Odoo SH', 'Migração por módulo + testes', 'Odoo v18 em Odoo SH', 'Preparação técnica v19'],
  ...
  },
  {
    ...
    image: '/projects/bi-platform.png',
    highlights: [
